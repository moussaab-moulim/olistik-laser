...
export const _Default = () => (
    <MyComponent
        slice={{
            ...
            items: [
                {
                    button_label: "changing",
                    button_url: { link_type: "Web", url: "https://prismic.io" },
                },
            ],
            primary: {
                slice_id: "love",
                title: [{ type: "heading1", text: "Bright", spans: [] }],
                text: [
                    {
                        type: "paragraph",
                        text: "Incididunt Lorem cillum est qui cillum tempor excepteur.",
                        spans: [],
                    },
                ],
                image: {
...
export const _RightText = () => (
    <MyComponent
        slice={{
            ...
            primary: {
                slice_id: "done",
                title: [{ type: "heading1", text: "Beautiful", spans: [] }],
                text: [
                    {
                        type: "paragraph",
                        text: "Ipsum Lorem quis pariatur cillum ex quis proident in mollit consectetur ex laboris dolor cillum.",
                        spans: [],
                    },
                ],
                image: {
